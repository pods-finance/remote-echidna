...
echo "PR_NUMBER_2_STARTED=$(cat PR_NUMBER)" >> $GITHUB_ENV

get_pr_number 3_RUNNING
echo "PR_NUMBER_3_RUNNING=$(cat PR_NUMBER)" >> $GITHUB_ENV

get_pr_number 4_FINISHED
echo "PR_NUMBER_4_FINISHED=$(cat PR_NUMBER)" >> $GITHUB_ENV

echo "ECHIDNA_LOGS=$(cat logs.txt)" >> $GITHUB_ENV